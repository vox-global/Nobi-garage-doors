...
use App\Models\BlogCategories as MainModel;
...
class BlogCategoriesController extends Controller
{
    ...
    public $folder_name = 'blog_categories'; // For view routes and file calling and saving
    public $module_name = 'Blog Categories'; // For toast And page header
