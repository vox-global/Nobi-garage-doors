    ...
    static function input_elements()
    {
        return [
            ...
            [
                "element_type" => "input",
                "input_type" => "text",
                "label" => "Inner Page Button Text",
                "name" => "inner_page_button_text",
                "placeholder" => "Enter Inner Page Button Text",
                "additional_ids" => [],
                "additional_classes" => [],
                "html_params" => [],
            ],
            [
                "element_type" => "input",
                "input_type" => "text",
                "label" => "Inner Page Heading",
                "name" => "inner_page_heading",
                "placeholder" => "Enter Inner Page Heading",
                "additional_ids" => [],
                "additional_classes" => [],
                "html_params" => [],
            ],
