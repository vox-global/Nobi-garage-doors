                                    ...
                                    <div class="row row-cols-xxl-4 row-cols-xl-3 row-cols-lg-3 row-cols-md-3 row-cols-2 mb--n30">
                                            ...
                                            <div class="product__items ">
                                                <div class="product__items--thumbnail">
                                                    <a class="product__items--link" href="product-details.php">
                                                        <img class="product__items--img product__primary--img" src="assets/img/product/art1.jpg" alt="product-img">
                                                    </a>
                                                ...
                                                <div class="product__items--content text-center">
                                                    <h3 class="product__items--content__title h4"><a href="product-details.php">Art 1</a></h3>
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items ">
                                                <div class="product__items--thumbnail">
                                                    <a class="product__items--link" href="product-details.php">
                                                        <img class="product__items--img product__primary--img" src="assets/img/product/art2.jpg" alt="product-img">
                                                    </a>
                                                    <ul class="product__items--action d-flex justify-content-center">
                                                        <li class="product__items--action__list">
                                                            <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                                                ...
                                                <div class="product__items--content text-center">
                                                    <h3 class="product__items--content__title h4"><a href="product-details.php">Art 2</a></h3>
                                                    <div class="product__items--price">
                                                        <span class="current__price">$150.00</span>
                                                        <!-- <span class="old__price">$200.00</span> -->
                                                    </div>
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items ">
                                                <div class="product__items--thumbnail">
                                                    <a class="product__items--link" href="product-details.php">
                                                        <img class="product__items--img product__primary--img" src="assets/img/product/art3.jpg" alt="product-img">
                                                    </a>
                                                    <ul class="product__items--action d-flex justify-content-center">
                                                        <li class="product__items--action__list">
                                                            <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                                                ...
                                                <div class="product__items--content text-center">
                                                    <h3 class="product__items--content__title h4"><a href="product-details.php">Art 3</a></h3>
                                                    <div class="product__items--price">
                                                        <span class="current__price">$150.00</span>
                                                        <!-- <span class="old__price">$200.00</span> -->
                                                    </div>
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items ">
                                                <div class="product__items--thumbnail">
                                                    <a class="product__items--link" href="product-details.php">
                                                        <img class="product__items--img product__primary--img" src="assets/img/product/art4.jpg" alt="product-img">
                                                    </a>
                                                    <ul class="product__items--action d-flex justify-content-center">
                                                        <li class="product__items--action__list">
                                                            <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                                                ...
                                                <div class="product__items--content text-center">
                                                    <h3 class="product__items--content__title h4"><a href="product-details.php">Art 4</a></h3>
                                                    <div class="product__items--price">
                                                        <span class="current__price">$150.00</span>
                                                        <!-- <span class="old__price">$200.00</span> -->
                                                    </div>
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items ">
                                                <div class="product__items--thumbnail">
                                                    <a class="product__items--link" href="product-details.php">
                                                        <img class="product__items--img product__primary--img" src="assets/img/product/art5.jpg" alt="product-img">
                                                    </a>
                                                    <ul class="product__items--action d-flex justify-content-center">
                                                        <li class="product__items--action__list">
                                                            <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                                                ...
                                                <div class="product__items--content text-center">
                                                    <h3 class="product__items--content__title h4"><a href="product-details.php">Art 5</a></h3>
                                                    <div class="product__items--price">
                                                        <span class="current__price">$150.00</span>
                                                        <!-- <span class="old__price">$200.00</span> -->
                                                    </div>
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items ">
                                                <div class="product__items--thumbnail">
                                                    <a class="product__items--link" href="product-details.php">
                                                        <img class="product__items--img product__primary--img" src="assets/img/product/art6.jpg" alt="product-img">
                                                    </a>
                                                    <ul class="product__items--action d-flex justify-content-center">
                                                        <li class="product__items--action__list">
                                                            <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                                                ...
                                                <div class="product__items--content text-center">
                                                    <h3 class="product__items--content__title h4"><a href="product-details.php">Art 6</a></h3>
                                                    <div class="product__items--price">
                                                        <span class="current__price">$150.00</span>
                                                        <!-- <span class="old__price">$200.00</span> -->
                                                    </div>
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items ">
                                                <div class="product__items--thumbnail">
                                                    <a class="product__items--link" href="product-details.php">
                                                        <img class="product__items--img product__primary--img" src="assets/img/product/art7.jpg" alt="product-img">
                                                    </a>
                                                    <ul class="product__items--action d-flex justify-content-center">
                                                        <li class="product__items--action__list">
                                                            <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                                                ...
                                                <div class="product__items--content text-center">
                                                    <h3 class="product__items--content__title h4"><a href="product-details.php">Art 7</a></h3>
                                                    <div class="product__items--price">
                                                        <span class="current__price">$150.00</span>
                                                        <!-- <span class="old__price">$200.00</span> -->
                                                    </div>
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items ">
                                                <div class="product__items--thumbnail">
                                                    <a class="product__items--link" href="product-details.php">
                                                        <img class="product__items--img product__primary--img" src="assets/img/product/art9.jpg" alt="product-img">
                                                    </a>
                                                    <ul class="product__items--action d-flex justify-content-center">
                                                        <li class="product__items--action__list">
                                                            <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                                                ...
                                                <div class="product__items--content text-center">
                                                    <h3 class="product__items--content__title h4"><a href="product-details.php">Art 8</a></h3>
                                                    <div class="product__items--price">
                                                        <span class="current__price">$150.00</span>
                                                        <!-- <span class="old__price">$200.00</span> -->
                                                    </div>
