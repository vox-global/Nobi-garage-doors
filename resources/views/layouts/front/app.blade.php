...
<body>
                    ...
                    <div class="header__menu position__relative d-none d-lg-block">
                        <nav class="header__menu--navigation">
                            <ul class="d-flex justify-content-center">
                                ...
                                <li class="header__menu--items mega__menu--items">
                                    <a class="header__menu--link" href="artist.php">Artist</a>
                                </li>
                                <li class="header__menu--items">
            ...
            <div class="minicart__product">
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumbnail">
                        <a href="product-details.php"><img src="{{ asset('front/img/product/art1.jpg') }}"
                                alt="prduct-img"></a>
                    </div>
                    <div class="minicart__text">
                        <h4 class="minicart__subtitle"><a href="product-details.php">Art 1</a></h4>
                ...
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumbnail">
                        <a href="product-details.php"><img src="{{ asset('front/img/product/art2.jpg') }}"
                                alt="prduct-img"></a>
                    </div>
                    <div class="minicart__text">
                        <h4 class="minicart__subtitle"><a href="product-details.php">Art 2</a></h4>
                        <div class="minicart__price">
                            <span class="current__price">$150.00</span>
                        </div>
                        <div class="minicart__text--footer d-flex align-items-center">
    ...
    <footer class="footer__section footer__bg color-scheme-2">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer__widget">
                            ...
                            <div class="footer__widget--inner">
                                <a class="footer__logo" href="index.php"><img
                                        src="{{ asset('front/img/logo/logo-clr.svg') }}" alt="footer-logo"></a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer__widget">
                            ...
                            <ul class="footer__widget--menu footer__widget--inner">
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text"
                                        href="my-account.php">My Account</a></li>
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text"
            ...
            <div class="footer__bottom d-flex justify-content-between align-items-center">
                <p class="copyright__content">Copyright © 2023 <a class="copyright__content--link"
                        href="index.php">Sketchbook Online</a> . All Rights Reserved.</p>
                <div class="footer__payment text-right">
                    <img class="footer__payment--visa__card display-block"
                        src="{{ asset('front/img/other/payment-visa-card.webp') }}" alt="visa-card">
                </div>
            </div>
        </div>
    </footer>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox"
                                                ...
                                                href="{{ asset('front/img/product/art1.jpg') }}"><img
                                                    class="product__media--preview__items--img"
                                                    src="{{ asset('front/img/product/art1.jpg') }}"
                                                    alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox"
                                                    href="{{ asset('front/img/product/art1.jpg') }}"
                                                    data-gallery="product-media-preview">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox"
                                                data-gallery="product-media-preview"
                                                href="{{ asset('front/img/product/big-product2.webp') }}"><img
                                                    class="product__media--preview__items--img"
                                                    src="{{ asset('front/img/product/big-product2.webp') }}"
                                                    alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox"
                                                    href="{{ asset('front/img/product/big-product2.webp') }}"
                                                    data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg"
                                                        xmlns="http://www.w3.org/2000/svg" width="22.51"
                                                        height="22.443" viewBox="0 0 512 512">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox"
                                                data-gallery="product-media-preview"
                                                href="{{ asset('front/img/product/big-product3.webp') }}"><img
                                                    class="product__media--preview__items--img"
                                                    src="{{ asset('front/img/product/big-product3.webp') }}"
                                                    alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox"
                                                    href="{{ asset('front/img/product/big-product3.webp') }}"
                                                    data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg"
                                                        xmlns="http://www.w3.org/2000/svg" width="22.51"
                                                        height="22.443" viewBox="0 0 512 512">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox"
                                                data-gallery="product-media-preview"
                                                href="{{ asset('front/img/product/big-product4.webp') }}"><img
                                                    class="product__media--preview__items--img"
                                                    src="{{ asset('front/img/product/big-product4.webp') }}"
                                                    alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox"
                                                    href="{{ asset('front/img/product/big-product4.webp') }}"
                                                    data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg"
                                                        xmlns="http://www.w3.org/2000/svg" width="22.51"
                                                        height="22.443" viewBox="0 0 512 512">
                            ...
                            <form action="#">
                                ...
                                <div class="product__variant">
                                    ...
                                    <div class="quickview__variant--list variant__wishlist mb-15">
                                        <a class="variant__wishlist--icon" href="wishlist.php"
            ...
            <div class="box newsletter__popup--box d-flex align-items-center">
                <div class="newsletter__popup--thumbnail">
                    <img class="newsletter__popup--thumbnail__img display-block"
                        src="{{ asset('front/img/banner/newsletter-popup-thumb2.png') }}"
    ...
    <script src="{{ asset('front/js/plugins/swiper-bundle.min.js') }}" defer="defer"></script>
    <script src="{{ asset('front/js/plugins/glightbox.min.js') }}" defer="defer"></script>

    <!-- Customscript js -->
    <script src="{{ asset('front/js/script.js') }}" defer="defer"></script>
